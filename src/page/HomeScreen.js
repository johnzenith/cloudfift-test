                ...
                <Grid container spacing={0} style={{ marginTop: '-113px' }}>
                    <Grid item sm>
                        <Paper className={clsx(classes.paper, classes.alignCenter, classes.productEvaluation)}>
                            ...
                            <Button className={clsx(classes.getStartedBtn, classes.investBtn)} variant="contained">Calculate</Button>
                        </Paper>
                    </Grid>
                </Grid>
                    ...
                    <Grid className={classes.guidelineGridContainer} container spacing={0}>
                        <Grid item xs={4}>
                            <Paper className={clsx(classes.paper, classes.alignCenter)}>
                                ...
                                <Typography component="p" className={clsx(classes.tagline, classes.description, classes.guidelineStepDescription)}>
                        ...
                        <Grid className={classes.channelListGrid} container spacing={0}>
                            <Grid item xs={3}>
                                <Paper className={clsx(classes.paper, classes.alignCenter, classes.paperChannel)}>
                                    ...
                                    <Typography component="p" className={clsx(classes.tagline, classes.guidelineStepDescription, classes.channelSource)}>
                            ...
                            <Grid item xs={3}>
                                <Paper className={clsx(classes.paper, classes.alignCenter, classes.paperChannel, classes.contactUsPaper)}>
